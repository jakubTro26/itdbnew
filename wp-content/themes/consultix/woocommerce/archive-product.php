	...
	<div class="wraper_shop_main">
		<div class="container">
			...
			<div class="row">
            	...
            	<?php } else { ?>
            	    <?php if ( 'shop-nosidebar' === consultix_global_var( 'shop-sidebar', '', false ) ) { ?>
    					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    				<?php } else { ?>
    					<?php if ( 'shop-leftsidebar' === consultix_global_var( 'shop-sidebar', '', false ) ) { ?>
    						<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right">
    					<?php } elseif ( 'shop-rightsidebar' === consultix_global_var( 'shop-sidebar', '', false ) ) { ?>
				...
				<?php } else { ?>
					...
					<?php } ?>
						...
						<?php
							 ...
							 * Sidebar
							 */
							dynamic_sidebar( 'consultix-product-sidebar' );
						?>
						</aside>
					</div>
				<?php } ?>
