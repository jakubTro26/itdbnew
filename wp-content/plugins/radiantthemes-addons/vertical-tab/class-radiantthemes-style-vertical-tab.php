...
if ( ! class_exists( 'RadiantThemes_Style_Tabs' ) ) {
	...
	class RadiantThemes_Style_Tabs {
		...
		public function __construct() {
			vc_map(
				array(
					'name'        => esc_html__( 'Tabs', 'radiantthemes' ),
					'base'        => 'rt_tab_style',
					'icon'        => plugins_url( 'radiantthemes-addons/tabs/icon/Tabs-Element-Icon.png' ),
					'class'       => 'wpb_rt_vc_extension_tab_style',
					'controls'    => 'full',
					'category'    => esc_html__( 'Radiant Elements', 'radiantthemes' ),
					'as_parent'   => array(
						'only' => 'rt_tab_style_item',
					),
					'js_view'     => 'VcColumnView',
					'description' => esc_html__( 'Tabbed Content', 'radiantthemes' ),
					'params'      => array(
						array(
							'type'        => 'dropdown',
							'heading'     => esc_html__( 'Select Tabs Style', 'radiantthemes' ),
							'param_name'  => 'radiant_tabsstyle',
							'value'       => array(
								esc_html__( 'Style One', 'radiantthemes' )   => 'one',
								esc_html__( 'Style Two', 'radiantthemes' )   => 'two',
								esc_html__( 'Style Three', 'radiantthemes' ) => 'three',
								esc_html__( 'Style Four', 'radiantthemes' )  => 'four',
							),
							'std'         => 'one',
							'admin_label' => true,
						),
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Tab Text Alignment', 'radiantthemes' ),
							'param_name' => 'tab_text_alignment',
							'std'        => 'left',
							'group'       => esc_html__( 'Typography & Color', 'radiantthemes' ),
							'value'      => array(
								esc_html__( 'Left', 'radiantthemes' )   => 'left',
								esc_html__( 'Center', 'radiantthemes' ) => 'center',
								esc_html__( 'Right', 'radiantthemes' )  => 'right',
							),
							'dependency' => array(
						...
						array(
							'type'             => 'textfield',
							'heading'          => esc_html__( 'Border Left', 'radiantthemes' ),
						...
						array(
							'type'             => 'textfield',
							'heading'          => esc_html__( 'Border Top', 'radiantthemes' ),
						...
						array(
							'type'             => 'textfield',
							'heading'          => esc_html__( 'Border Right', 'radiantthemes' ),
						...
						array(
							'type'             => 'textfield',
							'heading'          => esc_html__( 'Border Bottom', 'radiantthemes' ),
						...
						array(
							'type'             => 'dropdown',
							'heading'          => esc_html__( 'Border Style', 'radiantthemes' ),
							'param_name'       => 'tab_border_style',
							'std'              => 'solid',
							'group'            => esc_html__( 'Typography & Color', 'radiantthemes' ),
							'edit_field_class' => 'vc_col-xs-6 vc_column',
							'value'            => array(
								esc_html__( 'Theme Defaults', 'radiantthemes' ) => '',
								esc_html__( 'Solid', 'radiantthemes' )          => 'solid',
								esc_html__( 'Dotted', 'radiantthemes' )         => 'dotted',
								esc_html__( 'Dashed', 'radiantthemes' )         => 'dashed',
								esc_html__( 'None', 'radiantthemes' )           => 'none',
								esc_html__( 'Hidden', 'radiantthemes' )         => 'hidden',
								esc_html__( 'Double', 'radiantthemes' )         => 'double',
								esc_html__( 'Groove', 'radiantthemes' )         => 'groove',
								esc_html__( 'Ridge', 'radiantthemes' )          => 'ridge',
								esc_html__( 'Inset', 'radiantthemes' )          => 'inset',
								esc_html__( 'Outset', 'radiantthemes' )         => 'outset',
								esc_html__( 'Initial', 'radiantthemes' )        => 'initial',
								esc_html__( 'Inherit', 'radiantthemes' )        => 'inherit',
							),
							'dependency' => array(
								'element' => 'radiant_tabsstyle',
								'value'   => 'one',
						...
						array(
							'type'             => 'textfield',
							'heading'          => esc_html__( 'Border Radius', 'radiantthemes' ),
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__( 'Tab Menu Color', 'radiantthemes' ),
							'param_name'  => 'radiant_titlecolor',
							'description' => esc_html__( 'The font color of tab in normal mode.', 'radiantthemes' ),
							'group'       => esc_html__( 'Typography & Color', 'radiantthemes' ),
							'admin_label' => true,
							'dependency' => array(
								'element' => 'radiant_tabsstyle',
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__( 'Tab Menu Background Color', 'radiantthemes' ),
							'param_name'  => 'radiant_titlebg',
							'description' => esc_html__( 'The background color of tab in normal mode.', 'radiantthemes' ),
							'group'       => esc_html__( 'Typography & Color', 'radiantthemes' ),
							'admin_label' => true,
							'dependency' => array(
								'element' => 'radiant_tabsstyle',
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__( 'Tab Menu Hover Font Color', 'radiantthemes' ),
							'param_name'  => 'radiant_titlehovercolor',
							'description' => esc_html__( 'The font color of tab when user hover or in current mode.', 'radiantthemes' ),
							'group'       => esc_html__( 'Typography & Color', 'radiantthemes' ),
							'admin_label' => true,
							'dependency' => array(
								'element' => 'radiant_tabsstyle',
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__( 'Tab Menu Background Hover Color', 'radiantthemes' ),
							'param_name'  => 'radiant_titlehoverbg',
							'description' => esc_html__( 'The background color of tab when user hover or in current mode.', 'radiantthemes' ),
							'group'       => esc_html__( 'Typography & Color', 'radiantthemes' ),
							'admin_label' => true,
							'dependency' => array(
								'element' => 'radiant_tabsstyle',
						...
						array(
							'type'        => 'textfield',
							'heading'     => esc_html__( 'Container Width', 'radiantthemes' ),
							'param_name'  => 'radiant_containerwidth',
							'description' => esc_html__( 'The width of the whole contaienr, default is 100%. You can specify it with a smaller value, like 80%, and it will align center automatically.', 'radiantthemes' ),
							'admin_label' => true,
						),
						array(
							'type'       => 'checkbox',
							'heading'    => esc_html__( 'Tab Width Auto Adjust', 'radiantthemes' ),
							'param_name' => 'radiant_tab_adjust',
						),
						array(
							'type'        => 'textfield',
							'heading'     => esc_html__( 'Extra class name for the container', 'radiantthemes' ),
							'param_name'  => 'radiant_extra_class',
							'description' => esc_html__( 'If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.', 'radiantthemes' ),
							'admin_label' => true,
						),
						array(
							'type'        => 'textfield',
							'heading'     => esc_html__( 'Element ID', 'radiantthemes' ),
						...
						array(
							'type'       => 'css_editor',
							'heading'    => esc_html__( 'CSS', 'radiantthemes' ),
							'param_name' => 'tab_menu_css',
							'group'      => esc_html__( 'Tab Menu Design', 'radiantthemes' ),
							'dependency' => array(
								'element' => 'radiant_tabsstyle',
								'value'   => 'one',
							),
						...
						array(
							...
							'group'      => esc_html__( 'Tab Content Design', 'radiantthemes' ),
							'dependency' => array(
								'element' => 'radiant_tabsstyle',
								'value'   => 'one',
							),
			...
			vc_map(
				array(
					'name'                    => esc_html__( 'Tab Item', 'radiantthemes' ),
					'base'                    => 'rt_tab_style_item',
					'description'             => esc_html__( 'Add the title and content', 'radiantthemes' ),
					'as_child'                => array(
						'only' => 'rt_tab_style',
					),
					...
					'params'                  => array(
						array(
							'type'       => 'checkbox',
							'heading'    => esc_html__( 'Display Icons?', 'radiantthemes' ),
							'param_name' => 'radiant_display_icon',
						),
						array(
							'type'        => 'dropdown',
							'heading'     => esc_html__( 'Icon library', 'radiantthemes' ),
							'value'       => array(
								esc_html__( 'Font Awesome', 'radiantthemes' ) => 'fontawesome',
								esc_html__( 'Entypo', 'radiantthemes' )       => 'entypo',
								esc_html__( 'Open Iconic', 'radiantthemes' )  => 'openiconic',
								esc_html__( 'Typicons', 'radiantthemes' )     => 'typicons',
								esc_html__( 'Linecons', 'radiantthemes' )     => 'linecons',
								esc_html__( 'Material', 'radiantthemes' )     => 'material',
							),
							'admin_label' => true,
							'param_name'  => 'radiant_tabicon',
							'description' => esc_html__( 'Select icon library.', 'radiantthemes' ),
							'dependency'  => array(
						...
						array(
							'type'        => 'iconpicker',
							'heading'     => esc_html__( 'Icon', 'radiantthemes' ),
							...
							'description' => esc_html__( 'Select icon from library.', 'radiantthemes' ),
							'admin_label' => true,
						),
						array(
							'type'        => 'iconpicker',
						...
						array(
							'type'        => 'textfield',
							'heading'     => esc_html__( 'Tab Title', 'radiantthemes' ),
						...
						array(
							'type'       => 'textarea_html',
							'holder'     => 'div',
							'heading'    => esc_html__( 'Tab Content', 'radiantthemes' ),
							'param_name' => 'content',
						),
						array(
							'type'       => 'tab_id',
							'heading'    => esc_html__( 'Tab ID', 'radiantthemes' ),
