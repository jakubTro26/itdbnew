 ...
 * Class Definition.
 */
class Consultix_Social_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'consultix_social_widget',
			// Widget name will appear in UI.
			esc_html__( 'Consultix Social', 'consultix' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Widget for Social.', 'consultix' ),
			)
		);
	}
 ...
 */
function consultix_social_load_widget() {
	register_widget( 'Consultix_Social_Widget' );
}
add_action( 'widgets_init', 'consultix_social_load_widget' );
