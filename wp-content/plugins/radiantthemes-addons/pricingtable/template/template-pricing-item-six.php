...
$style  = '.rt-pricing-table.element-six.' . $random_class . ' > .holder > .title, .rt-pricing-table.element-six.' . $random_class . ' > .holder > .price{background-color:';
$style .= $shortcode['background_color'] . ';}';
$style .= '.rt-pricing-table.element-six.' . $random_class . ' > .holder  > .data .btn {background-color:';
