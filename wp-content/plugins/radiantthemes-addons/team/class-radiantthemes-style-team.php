...
if ( class_exists( 'WPBakeryShortCode' ) && ! class_exists( 'Radiantthemes_Style_Team' ) ) {
	...
	class Radiantthemes_Style_Team extends WPBakeryShortCode {
		...
		public function __construct() {
			vc_map(
				array(
					...
					'icon'        => plugins_url( 'radiantthemes-addons/team/icon/Team-Element-Icon.png' ),
					...
					'params'      => array(
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Style Fourteen', 'radiantthemes-addons' ) => 'fourteen',
								esc_html__( 'Style Fifteen', 'radiantthemes-addons' ) => 'fifteen',
							),
							'std'        => 'one',
						),
						array(
		...
		public function radiantthemes_team_style_func( $atts, $content = null, $tag ) {
			...
			if ( 'true' == $shortcode['team_allow_carousel'] ) {
				wp_register_style(
					'owl-carousel',
			...
			wp_register_style(
				'radiantthemes_team_nav_dot_style',
				plugins_url( 'radiantthemes-addons/team/css/radiantthemes-team-nav-dot-style.css' )
			);
			wp_enqueue_style( 'radiantthemes_team_nav_dot_style' );

			wp_register_style(
				'radiantthemes_team_' . $shortcode['style_variation'],
				plugins_url( 'radiantthemes-addons/team/css/radiantthemes-team-element-' . $shortcode['style_variation'] . '.css' )
			);
			wp_enqueue_style( 'radiantthemes_team_' . $shortcode['style_variation'] );

			wp_register_script(
				'radiantthemes_team_' . $shortcode['style_variation'],
				plugins_url( 'radiantthemes-addons/team/js/radiantthemes-team-element-' . $shortcode['style_variation'] . '.js' ),
				array( 'jquery' ),
				false,
				true
			);
			wp_enqueue_script( 'radiantthemes_team_' . $shortcode['style_variation'] );
