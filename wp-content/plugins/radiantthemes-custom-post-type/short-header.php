	    ...
	    <div class="radiantthemes-page-options-body">
	        ...
	        <div class="radiantthemes-page-options-body-image-selector">
	            <ul id="RadiantThemesPageHeaderSelector">
            		...
            		<li class="header-eleven"><input type="radio" name="selectheader" value="eleven" <?php checked( $vselectheader, 'eleven' ); ?> ></li>
	            </ul>
	        </div>
	        <!-- radiantthemes-page-options-body-image-selector -->
	    </div>
...
function radiantthemes_page_save_postdata( $post_id ) {
	if ( ( false == strpos( $_SERVER['REQUEST_URI'], 'post-new.php' ) ) && ( false == strpos( $_SERVER['REQUEST_URI'], 'nav-menus.php' ) ) && ( false == strpos( $_SERVER['REQUEST_URI'], 'admin.php' ) ) ) {
